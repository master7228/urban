                        ...
                        <div class="row" id="DinamicContentMovile" style="margin-right:0px !important; margin-left:0px !important; ">
                           <div class="col-md-12 col-lg-12" style="padding-right: 0px !important; padding-left:0px !important; ">
                              <div class="w-100 text-dark"  >
                                 <div class="card shadow mb-4 w-100 "> 
                                    <div>
                                    <div><h2 class="font-weight-bold text-primary text-uppercase">Domis Asignados: <?php echo count($deliverys);  ?></h2></div>
                                       <?php 
                                          if(count($deliverys)>0){
                                          foreach ($deliverys as $key => $value) {
                                             $domiciliary = "Sin Asignar";
                                                                     ...
                                                                     <div class="row no-gutters align-items-center">
                                                                        <div class="col mr-2">
                                                                           <div class=" text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                                              <input type="hidden" id="price_delivery<?php echo $value['idd']; ?>" name="price_delivery<?php echo $value['idd']; ?>" value="<?php echo $value['price_delivery'];  ?>">
                                                                              <select class="form-control id_delivery_status" id="id_delivery_status<?php echo $value['idd']; ?>" data-id="<?php echo $value['idd']; ?>" name="id_delivery_status<?php echo $value['idd']; ?>" style="font-weight: bold; text-align:center" required>
                                       ...
                                       <?php 
                                             ...
                                             echo '<h3 style="color:red">No hay guías asignadas</h3>';
                                          }
                                       ?>
    ...
    $(document).ready( function () {
      ...
      $(".id_delivery_status").on('change',function () {
         ...
         if($(this).val() != ''){
            ...
            var price_delivery = $.trim($('#price_delivery'+$(this).attr("data-id")).val());
