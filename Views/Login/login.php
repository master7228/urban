                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-6">
                                    <form class="transfot needs-validation" id="frmlogin">
                                       ...
                                       <div class="col-md-12">
                                          <input class="transfot_form" placeholder="Correo" type="text" name="user" id="user" required>
                                       </div>
                                       <div class="col-md-12">
                ...
                form.addEventListener('submit', function (event) {
                    ...
                    $.ajax({
                        ...
                        success: function(response){
                           var uuid_client = response;
                            console.log(response);

                            if(response != 0){
                              window.location.href = "<?php echo URL; ?>App/app/"+response;
                            }else{
