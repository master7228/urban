                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-md-6">
                                             ...
                                             <div class="col-md-12 form-group">
                                                ...
                                                <select class="form-control" id="domiciliary_document_type" name="domiciliary_document_type" required>
                                             ...
                                             <div class="col-md-12 form-group">
                                                ...
                                                <input type="text" class="form-control" id="domiciliary_document" name="domiciliary_document" required>
                                             </div>
                                             <div class="col-md-12 form-group">
                                                <label for="domiciliary_name" class="form-label">Nombre</label>
                                                <input type="text" class="form-control" id="domiciliary_name" name="domiciliary_name" required>
                                             </div>
                                             <div class="col-md-12 form-group">
                                                <label for="domiciliary_phone" class="form-label">Teléfono / Celular</label>
                                                <input type="text" class="form-control" id="domiciliary_phone" name="domiciliary_phone" required>
                                             </div>
                                             ...
                                             <div class="col-md-12 form-group">
                                                ...
                                                <input type="text" class="form-control" style = "text-transform: uppercase;" id="domiciliary_vehicle" name="domiciliary_vehicle" required>
                                             </div>
          
                                             <div class="col-md-12 form-group">
                                                <label for="domiciliary_plate_vehicle" class="form-label">Placa del vehículo</label>
                                                <input type="text" class="form-control" id="domiciliary_plate_vehicle" name="domiciliary_plate_vehicle" style = "text-transform: uppercase;" required>
                                             </div>
                                             <div class="col-md-12 form-group">
        ...
        $(function () {
            ...
            Array.prototype.slice.call(forms).forEach(function (form) {
                form.addEventListener('submit', function (event) {
                    ...
                    var domiciliary_document_type = $.trim($("#domiciliary_document_type").val());
                    var domiciliary_document = $.trim($("#domiciliary_document").val());
                    var domiciliary_name = $.trim($("#domiciliary_name").val());
                    var domiciliary_phone = $.trim($("#domiciliary_phone").val());
                    var domiciliary_vehicle = $.trim($("#domiciliary_vehicle").val().toUpperCase());
                    var domiciliary_plate_vehicle = $.trim($("#domiciliary_plate_vehicle").val().toUpperCase());
                    var domiciliary_status = $.trim($("#domiciliary_status").val());

                    $.ajax({
                        type:"POST",
                        url: "<?php echo URL; ?>Domiciliary/create",
                        data: {  
                                 domiciliary_document_type:domiciliary_document_type, 
                                 domiciliary_document:domiciliary_document,
                        ...
                        success: function(response){
                            if(response != 0){
                                jQuery("#modalMessage").text('Domiciliario creado correctamente!');
